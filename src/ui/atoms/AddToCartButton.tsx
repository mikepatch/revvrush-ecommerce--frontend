	...
	return (
		<button
			...
			className={clsx(
				...
				variant === "both" &&
					"gap-2 bg-brand-primary px-4 py-2 text-font-light transition-all hover:brightness-105 ",
				variant === "icon" &&
					"gap-1 border border-brand-primary bg-transparent px-1 !text-brand-primary transition-colors hover:bg-brand-primary hover:!text-font-light",
			)}
		>
